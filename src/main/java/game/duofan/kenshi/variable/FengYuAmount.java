...
import game.duofan.kenshi.card.YuZL_FengYuBuDong;

import java.util.ArrayList;

public class FengYuAmount extends DynamicVariable {
    @Override
    public String key() {
        return "duofan_kenshi:FengYuAmount";
    ...
    public int baseValue(AbstractCard card) {
        if (!(card instanceof YuZL_FengYuBuDong)) {
            return 0;
        }
