...
public class FZL_FuFeng extends CustomCard implements IFengZhiLiuCard {
    public static final String ID = IDManager.getInstance().getID(FZL_FuFeng.class);
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID); // 从游戏系统读取本地化资源
    private static final String NAME = CARD_STRINGS.NAME; // 读取本地化的名字
    private static final String IMG_PATH = "img/cards/fZL/fuFeng_power.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        Utils.playerGainPower(new FuFeng(p, magicNumber));
    }
