...
public class YanZL_LuoXuanYan extends CustomCard implements IYanZhiLiuCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        int d = damage;
        if(Utils.isIntentAttack(m) && Liu_StateMachine.getInstance().getLiu() == Liu_StateMachine.StateEnum.YanZhiLiu){
            d += magicNumber;
        }
        Utils.giveBaoYanDamage(p, m, d, DamageInfo.DamageType.NORMAL);
    }
