...
public class YZL_YingZhiXin extends CustomCard implements IYingZhiLiuCard {
    public static final String ID = IDManager.getInstance().getID(YZL_YingZhiXin.class);
