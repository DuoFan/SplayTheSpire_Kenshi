...
public class XZL_QiChongDouNiu extends CustomCard implements IXiaZhiLiuCard, IQiLamagePlus {
    ...
    private static final String IMG_PATH = "img/cards/xZL/QiChongDouNiu_attack.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        Utils.giveDamage(p,m,new QiLamagePlus().value(this), DamageInfo.DamageType.NORMAL, AbstractGameAction.AttackEffect.BLUNT_HEAVY);
