...
public class XZL_PoXiao extends CustomCard implements IXiaZhiLiuCard, IQiMin {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new DamageAction(m, new DamageInfo(p, attackingDamage, DamageInfo.DamageType.NORMAL)));
    }
    ...
    public void xiaZhiLiuEffect(boolean isByQi) {
        if (monster != null && attackingDamage > 0) {
            AbstractPlayer p = AbstractDungeon.player;
            int _damage = (int) (attackingDamage * coex);
            this.addToBot(new DamageAction(monster, new DamageInfo(p, _damage, DamageInfo.DamageType.NORMAL)));
        }
    }
