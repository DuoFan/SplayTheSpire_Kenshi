...
public class XZL_MingXinHui extends CustomCard implements IXiaZhiLiuCard {
    public static final String ID = IDManager.getInstance().getID(XZL_MingXinHui.class);
    ...
    public XZL_MingXinHui() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
        this.magicNumber = this.baseMagicNumber = 1;
        this.cardsToPreview = new YuZL_HuXinHui(true);
    }

    public XZL_MingXinHui(boolean dontPreview) {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
        this.magicNumber = this.baseMagicNumber = 1;
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractCard c = new YuZL_HuXinHui();
