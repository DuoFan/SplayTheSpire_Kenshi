...
import game.duofan.kenshi.action.BanXingAction;
import game.duofan.kenshi.action.PickUpCardToLinkAction;
import game.duofan.kenshi.power.*;

public class SZL_BanXing extends CustomCard implements IShanZhiLiuCard {

    public static final String ID = IDManager.getInstance().getID(SZL_BanXing.class);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        targetCard = null;
        addToBot(new BanXingAction(this));
    }
    ...
    public void shanZhiLiuEffect() {
        Utils.addToBotAbstract(() ->{
            if(targetCard != null){
                IShanZhiLiuCard szlCard = (IShanZhiLiuCard) targetCard;
                if (szlCard.isExchangeAble()) {
                    szlCard.setToExchange();
                }
                targetCard = null;
            }
        });
