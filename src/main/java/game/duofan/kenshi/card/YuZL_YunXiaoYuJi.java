...
public class YuZL_YunXiaoYuJi extends CustomCard implements IYuZhiLiuCard {
    public static final String ID = IDManager.getInstance().getID(YuZL_YunXiaoYuJi.class);
    ...
    public void triggerOnGlowCheck() {
        ...
        if (Liu_StateMachine.getInstance().isStateMatch(Liu_StateMachine.StateEnum.YuZhiLiu)
                || ZhuLiuBaiJia.canForceInvokeLiu() || Utils.getQiAmount() > 0) {
