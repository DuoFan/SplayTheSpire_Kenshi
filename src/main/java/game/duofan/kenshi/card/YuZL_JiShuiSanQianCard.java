...
public class YuZL_JiShuiSanQianCard extends CustomCard implements IYuZhiLiuCard {
    ...
    public static final String ID = IDManager.getInstance().getID(YuZL_JiShuiSanQianCard.class);
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID); // 从游戏系统读取本地化资源
    private static final String NAME = CARD_STRINGS.NAME; // 读取本地化的名字
    private static final String IMG_PATH = "img/cards/yuZL/JiShuiSanQian_skill.png";
