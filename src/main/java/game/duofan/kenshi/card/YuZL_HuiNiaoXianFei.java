...
public class YuZL_HuiNiaoXianFei extends CustomCard implements IYuZhiLiuCard, IDoCard {
    public static final String ID = IDManager.getInstance().getID(YuZL_HuiNiaoXianFei.class);
