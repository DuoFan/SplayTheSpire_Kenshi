...
public class YuGan_Card extends CustomCard {
    public static final String ID = IDManager.getInstance().getID(YuGan_Card.class);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        Utils.playerGainPower(new YuGan(p, magicNumber));
    }
