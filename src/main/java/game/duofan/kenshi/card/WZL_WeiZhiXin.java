...
public class WZL_WeiZhiXin extends CustomCard implements IWeiZhiLiuCard {
    public static final String ID = IDManager.getInstance().getID(WZL_WeiZhiXin.class);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        WeiZhiXin.WeiZhiXinEffect();
        Utils.playerGainPower(new WeiZhiXin(p));
    }
