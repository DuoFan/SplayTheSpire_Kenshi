...
public class FZL_BaiHuaQiFang extends CustomCard implements IFengZhiLiuCard, ICardFilter {
    ...
    private static final String IMG_PATH = "img/cards/fZL/BaiHuaQiFang_power.png";
    ...
    public void fengZhiLiuEffect() {
        Utils.playerDrawCardByFilterAction(1, this);
    }
    ...
    public boolean filter(AbstractCard c) {
        return Utils.getLiuFromCard(c) == Liu_StateMachine.StateEnum.FengZhiLiu;
    }
}
