...
public class YanZL_YanZhiXin extends CustomCard implements IYanZhiLiuCard {
    public static final String ID = IDManager.getInstance().getID(YanZL_YanZhiXin.class);
