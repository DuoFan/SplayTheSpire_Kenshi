...
public class FZL_QianZhiZhe extends CustomCard implements IFengZhiLiuCard {

    public static final String ID = IDManager.getInstance().getID(FZL_QianZhiZhe.class);
