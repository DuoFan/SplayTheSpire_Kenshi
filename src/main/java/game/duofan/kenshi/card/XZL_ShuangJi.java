...
public class XZL_ShuangJi extends CustomCard implements IXiaZhiLiuCard {
    ...
    private static final String IMG_PATH = "img/cards/xZL/ShuangJi_skill.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new VFXAction(p, new VerticalAuraEffect(Color.SCARLET, p.hb.cX, p.hb.cY), 0.33F));
