...
public class FZL_HuiFengZhan extends CustomCard implements IFengZhiLiuCard, IEventListener {

    public static final String ID = IDManager.getInstance().getID(FZL_HuiFengZhan.class);
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID); // 从游戏系统读取本地化资源
    private static final String NAME = CARD_STRINGS.NAME; // 读取本地化的名字
    private static final String IMG_PATH = "img/cards/fZL/huiFengZhan_attack.png";
