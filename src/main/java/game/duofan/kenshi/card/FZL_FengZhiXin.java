...
public class FZL_FengZhiXin extends CustomCard implements IFengZhiLiuCard {
    public static final String ID = IDManager.getInstance().getID(FZL_FengZhiXin.class);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        Utils.playerGainPower(new FengZhiXin(p));
