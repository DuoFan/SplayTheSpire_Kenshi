...
public class DZL_QianChuiBaiLian extends CustomCard implements IDuanZhiLiuCard {

    public static final String ID = IDManager.getInstance().getID(DZL_QianChuiBaiLian.class);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new DuanZaoHandAction(null, magicNumber));
    }
