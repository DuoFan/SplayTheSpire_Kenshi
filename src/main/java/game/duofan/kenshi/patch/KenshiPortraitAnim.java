...
public class KenshiPortraitAnim {
    private String portraitAtlasUrl = "spineAnimation/Kenshi/break_JK.atlas";
    private String portraitJsonUrl = "spineAnimation/Kenshi/break_JK.json";
    private String portraitIMGUrl = "spineAnimation/Kenshi/break_JK.json";
