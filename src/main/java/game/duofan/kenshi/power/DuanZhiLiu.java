...
public class DuanZhiLiu extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID = IDManager.getInstance().getID(DuanZhiLiu.class);
    // 能力的本地化字段
    ...
    public DuanZhiLiu(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        ...
        if (card instanceof IDuanZhiLiuCard) {
