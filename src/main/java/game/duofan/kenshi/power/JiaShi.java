...
public class JiaShi extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID = IDManager.getInstance().getID(JiaShi.class);
    // 能力的本地化字段
    ...
    public JiaShi(AbstractCreature owner, int _amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
