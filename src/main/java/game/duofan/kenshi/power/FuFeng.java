...
public class FuFeng extends AbstractPower implements IEventListener {
    // 能力的ID
    ...
    public void onInitialApplication() {
        ...
        Utils.addToBotAbstract(() -> {
            EventManager.getInstance().registerToEvent(EventKey.ON_TURN_START, this);
        });
        updateDescription();
    }
    ...
    public void onVictory() {
        super.onVictory();
        EventManager.getInstance().unregisterFromEvent(EventKey.ON_TURN_START, this);
    }
