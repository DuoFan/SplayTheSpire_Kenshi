...
public class YingZhiXin extends AbstractPower implements IEventListener {
    // 能力的ID
    public static final String POWER_ID = IDManager.getInstance().getID(YingZhiXin.class);
    // 能力的本地化字段
    ...
    public void onVictory() {
        super.onVictory();
        EventManager.getInstance().unregisterFromEvent(EventKey.FIRST_YZL_ON_TURN, this);
    }
    ...
    public void OnEvent(Object sender, Object e) {
        ...
        if (p != null) {
            this.addToBot(new ApplyPowerAction(p, p, new AnYing(p)));
        }
    }
}