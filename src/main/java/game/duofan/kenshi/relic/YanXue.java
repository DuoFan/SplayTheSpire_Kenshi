...
// 继承CustomRelic
public class YanXue extends CustomRelic implements IEventListener {
    public static final String ID = IDManager.getInstance().getID(YanXue.class);
    ...
    public static final int DAMAGE_GIVE = 3;
