...
// 继承CustomRelic
public class JianChui extends CustomRelic {
    public static final String ID = IDManager.getInstance().getID(JianChui.class);
    ...
    public void atTurnStartPostDraw() {
        ...
        this.flash();
        addToBot(new DuanZaoHandAction(null, 2));
    }
}
