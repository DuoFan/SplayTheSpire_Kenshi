...
import game.duofan.kenshi.power.JiaShi;
import game.duofan.kenshi.power.Liu_StateMachine;
import game.duofan.kenshi.power.Shi_StateMachine;
import game.duofan.kenshi.power.ZhuLiuBaiJia;

// 继承CustomRelic
public class ChiYouXiang extends CustomRelic {
    public static final String ID = IDManager.getInstance().getID(ChiYouXiang.class);
