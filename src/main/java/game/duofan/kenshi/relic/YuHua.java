...
// 继承CustomRelic
public class YuHua extends CustomRelic implements IEventListener {
    public static final String ID = IDManager.getInstance().getID(YuHua.class);
    ...
    public void atBattleStart() {
        super.atBattleStart();
        EventManager.getInstance().registerToEvent(EventKey.ON_YU_CARD_PLAY,this);
    }
