...
// 继承CustomRelic
public class LiuPaiHuiZhang extends CustomRelic {
    public static final String ID = IDManager.getInstance().getID(LiuPaiHuiZhang.class);
